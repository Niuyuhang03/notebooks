...
+ [直通BAT面试算法精讲课](https://www.nowcoder.com/study/vod/1)：《剑指offer》的乱序讲解版，讲解不细，基本为串讲，有对应在线练习题，不讲解正确代码，==思路讲解的很辣鸡==，但难度有，适合科班学过，准备面试用。牛客网编译器不支持`print`，报错不给行号。
...
+ 题目：平衡二叉树不一定是完全二叉树，但每个结点的左子树和右子树高度差不超过1
+ 思路：对于每个节点，记录左右子树高度，同时判断左右子树书否为平衡二叉树
